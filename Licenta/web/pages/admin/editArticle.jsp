					...
					<div>
						<table id="formularContent">
							<tr>
								...
								<td><s:hidden name="id"
										value="%{articleList.get(0).getIdArticle()}" /> <s:textfield
										name="title" id="title"
										value="%{articleList.get(0).getTitle()}" /></td>
								<td><s:fielderror>
									...
									<div id="autors">
										<div>
											...
											<s:textfield id="authorFN" name="authorFN"
												value="%{articleList.get(0).getAutors().get(0).getFirstName()}" />
											<label id="authorLNLabel">Last Name:</label>
											<s:textfield id="authorLN" name="authorLN"
												value="%{articleList.get(0).getAutors().get(0).getLastName()}" />
										</div>
										<s:iterator value="articleList.get(0).getAutors()" begin="1"
											status="part">
											<div>
												<label id="authorFNLabel">First Name:</label>
							...
							<tr>
								...
								<td><s:textfield name="year" id="year"
										value="%{articleList.get(0).getYear()}" /></td>
								<td><s:fielderror>
							...
							<tr>
								...
								<td><s:textfield name="volume" id="volume"
										value="%{articleList.get(0).getVolume()}" /></td>
							</tr>
							<tr>
								<td><label>Number:</label></td>
								<td><s:textfield name="number" id="volume"
										value="%{articleList.get(0).getNumber()}" /></td>
							</tr>
							<tr>
								...
								<td><select name="month">
										...
										<s:iterator value="monthList" status="part">
											<s:if
												test="%{articleList.get(0).getMonth() == monthList.get(#part.index)}">
							...
							<tr>
								...
								<td><s:textarea name="note" id="note"
										value="%{articleList.get(0).getNote()}" /></td>
							</tr>
							<tr>
								<td></td>
								<td>
									<div id="buttonForm">
										<s:submit value="Update"
											onclick="return confirm('Are you sure you want to update this article')" />
